...
var byte_this_behavior_subject_1 = require("./byte-this-behavior-subject");
describe("ByteThisBehaviorSubject", function () {
    it("should call next and trigger subscriptions", function (done) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            curTest = 0;
            subject = new byte_this_behavior_subject_1.ByteThisBehaviorSubject();
    ...
    it("should react to another observable and update itself", function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var testValues, curTest, subjectToReactTo, subject;
        return __generator(this, function (_a) {
            testValues = [17, 12, 11, 15, 18, 564654, -1];
            curTest = 0;
            subjectToReactTo = new byte_this_behavior_subject_1.ByteThisBehaviorSubject();
            subject = new byte_this_behavior_subject_1.ByteThisBehaviorSubject()
    ...
    it("should set nextIfVoid to initialize subject's value", function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var testValue, initializer;
        return __generator(this, function (_a) {
            testValue = 123456;
            initializer = function () { return rxjs_1.of(testValue); };
            new byte_this_behavior_subject_1.ByteThisBehaviorSubject()
